 ...
 * D3D11 UMD folds them into its own cap answers.  All five are DXMT
 * capabilities D3DMetal lacks -- including TBDR, which is Metal on Apple
 * silicon either way, but which D3DMetal presents as immediate-mode. */
